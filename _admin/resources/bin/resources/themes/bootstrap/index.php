...
<html>
    ...
    <head>
        ...
        <!-- FONTS -->
        <link rel="stylesheet" type="text/css"  href="<?php echo THEMEPATH; ?>/css/font.css">
    ...
    <body>
        ...
        <div id="page-content" class="container">
            ...
            <div id="directory-list-header">
                <div class="row">
                    <div class="col-md-7 col-sm-6 col-xs-10">App</div>
                        ...
                        <a href="<?php echo $fileInfo['file_path']; ?>" class="clearfix" data-name="<?php echo $name; ?>">
                            ...
                            <div class="row">
                                <span class="file-name col-md-7 col-sm-6 col-xs-9">
                                    ...
                                    <?php echo  (PATH_SEPARATOR == ':')?$name:encode_iconv("gbk", "UTF-8", $name); ?>
                                </span>
